...
def init_db(update=False):
    ...
    db.session.add(Payment('虎皮椒支付宝','./aipay.png',"{'appid':'XXXXXX','AppSecret':'YYYYY'}",'官方合作接口 个人账户到账',False))
    db.session.add(Payment('虎皮椒微信','./aipay.png',"{'appid':'XXXXXX','AppSecret':'YYYYY'}",'官方合作接口 个人账户到账',True))
    db.session.add(Payment('PAYJS支付宝','./aipay.png',"{'payjs_key':'XXXXXX','mchid':'YYYYY','mchid':'ZZZZZZZ'}",'官方合作接口 个人账户到账',False))
    db.session.add(Payment('PAYJS微信','./aipay.png',"{'payjs_key':'XXXXXX','mchid':'YYYYY','mchid':'ZZZZZZZ'}",'官方合作接口 个人账户到账',False))
    db.session.add(Payment('码支付支付宝','./aipay.png',"{'codepay_id':'58027','codepay_key':'fgl454542WSDJHEJHDJZpTRrmbn','token':'jljCGU3pRvXXXXXXXXXXXb1iq'}",'挂机宝 个人账户到账',False))
    db.session.add(Payment('码支付微信','./aipay.png',"{'codepay_id':'58027','codepay_key':'fgl454542WSDJHEJHDJZpTRrmbn','token':'jljCGU3pRvXXXXXXXXXXXb1iq'}",'挂机宝 个人账户到账',False))
    db.session.add(Payment('码支付QQ','./aipay.png',"{'codepay_id':'58027','codepay_key':'fgl454542WSDJHEJHDJZpTRrmbn','token':'jljCGU3pRvXXXXXXXXXXXb1iq'}",'挂机宝 个人账户到账',False))
