...
def get_pay_url():  # 传递名称、支付方式、订单号，购买数量，联系方式---》推算价格
    ...
    if payment not in ['支付宝当面付','虎皮椒微信','虎皮椒支付宝','码支付微信','码支付支付宝','码支付QQ','PAYJS支付宝','PAYJS微信','微信官方接口','易支付QQ','易支付微信','易支付支付宝','Mugglepay','YunGouOS','YunGouOS_WXPAY','V免签微信','V免签支付宝','QQ钱包','随便付','Stripe支付宝','Stripe微信','云免签']:
        return '暂无该支付接口', 404
